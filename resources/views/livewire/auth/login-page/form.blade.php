<div class="my-auto">
    ...
    <form class="mt-4 pt-2"  wire:submit.prevent="login">
        <div class="mb-4">
            ...
            <input wire:model="email" name="email" type="email" class="w-full rounded placeholder:text-sm py-2 border-gray-100 dark:bg-zinc-700/50 dark:border-zinc-600 dark:text-gray-100 dark:placeholder:text-zinc-100/60"  placeholder="Masukan email" required>
        </div>
    ...
    <div class="mt-12 text-center">
        <p class="text-gray-500 dark:text-gray-100">Belum memiliki akun?<a href="{{route('register_page')}}" class="text-violet-500 font-semibold"> Daftar Sekarang!</a> </p>
    </div>
