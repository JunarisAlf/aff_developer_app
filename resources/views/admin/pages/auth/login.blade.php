                ...
                <div class="w-full bg-white xl:p-12 p-10 dark:bg-zinc-800">
                    <div class="flex h-[90vh] flex-col">
                            ...
                            <a href="index.html" class="">
                                <img src="{{asset('mania/images/logo-sm.svg')}}" alt="" class="h-8 inline"> <span class="text-xl align-middle font-medium ltr:ml-2 rtl:mr-2 dark:text-white">Dmas Group</span>
                            </a>
                        </div>
                        ...
                        <div class=" text-center">
                            <p class="text-gray-500 dark:text-gray-100 relative mb-5">© <script>document.write(new Date().getFullYear())</script> Dmas Group . Crafted with <i class="mdi mdi-heart text-red-400"></i> by Junaris</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-span-12 md:col-span-7 lg:col-span-8 xl:col-span-9">
                <div class="h-screen bg-cover relative p-5 bg-[url('mania/images/auth-bg.jpg')]">
