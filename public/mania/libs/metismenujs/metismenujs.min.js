...
!(function (t, e) {
    ...
    class s {
        ...
        init() {
            ...
            0 !== n.length &&
                n.forEach((t) => {
                    ...
                    (null == e ? void 0 : e.classList.contains(s))
                        ? this.show(t)
                        : this.hide(t);
                    const n =
                        null == e
                    ...
                    "true" !==
                        ...
                        null == n ||
                            n.addEventListener("click", this.boundEventHandler),
            ...
            if (!this.disposed) {
                ...
                const s = e.closest(this.config.parentTrigger),
                    i =
                        null == s
                            ? void 0
                            : s.querySelector(this.config.subMenu);
                this.toggle(i);
            }
        }
        update() {
        ...
        toggle(t) {
            ...
            (null == s ? void 0 : s.classList.contains(e.ACTIVE))
                ? this.hide(t)
                : this.show(t);
        }
        show(t) {
            ...
            const d =
                null == h
                    ? void 0
                    : h.querySelector(this.config.triggerElement);
            ...
            const g = [].slice
                .call(
                    null === (s = null == h ? void 0 : h.parentNode) ||
                        void 0 === s
                        ? void 0
                        : s.children
                )
        ...
        hide(t) {
            ...
            const h =
                null == c
                    ? void 0
                    : c.querySelector(this.config.triggerElement);
